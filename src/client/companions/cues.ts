...
const CUES: Record<CompanionMoment, readonly CompanionCue[]> = {
  "home-welcome": [
    { companion: "lumi", text: "버니의 지팡이가 딸꾹! 별 대신 양말 한 짝이 나왔어요.", tone: "humor" },
    ...
    { companion: "bongbong", text: "밀키가 불을 뿜으려다 비눗방울 왕관을 만들었어요.", tone: "humor" }
  ],
  "home-return": [
    { companion: "lumi", text: "돌아왔구나! 버니가 양말 별자리를 완성하는 중이래요.", tone: "humor" },
    ...
    { companion: "bongbong", text: "밀키의 왕관이 또 거꾸로예요. 그래도 아주 당당해요.", tone: "humor" }
  ],
  "lesson-open": [
  ...
  correct: [
    { companion: "bongbong", text: "정답이에요! 밀키의 축하 불꽃이 비눗방울로 변했어요.", tone: "humor" },
    { companion: "bongbong", text: "함께 해결했어요! 밀키의 왕관이 기뻐서 한 바퀴 돌았대요.", tone: "humor" }
  ],
  next: [
    { companion: "lumi", text: "다음 마법 걸음으로 가요. 버니가 도망간 양말을 잡아 둘게요.", tone: "humor" }
  ],
  offline: [
